public class JsonObject: JsonElement, IJsonObject {
    ...
    public static func fromObject<T>(_ obj: T) throws -> JsonObject where T: Encodable {
        ...
        if let result = result as? Dictionary<String, JsonValueRaw> {
